...
void    DIO_voidSetPortDirection(u8 copy_u8PortID,u8 copy_u8PortDir )
{
	switch ( copy_u8PortID)
	{
	case PORTA_ID : DDRA_REG = copy_u8PortID; break;
	case PORTB_ID : DDRB_REG = copy_u8PortID; break;
	case PORTC_ID : DDRC_REG = copy_u8PortID; break;
	case PORTD_ID : DDRD_REG = copy_u8PortID; break;
...
void    DIO_voidSetPortValue(u8 copy_u8PortID,u8 copy_u8PortVal )
{
	switch (copy_u8PortID)
	{
	    case PORTA_ID : PORTA_REG = copy_u8PortID; break;
		case PORTB_ID : PORTB_REG = copy_u8PortID; break;
		case PORTC_ID : PORTC_REG = copy_u8PortID; break;
		case PORTD_ID : PORTD_REG = copy_u8PortID; break;
	}
}
